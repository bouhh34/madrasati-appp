...
async function loadAcademicScope(){return loadBulkScope();}
function renderGradeGrid(){return renderBulkGrades();}
async function saveGrade(button){return saveBulkGrades([button.dataset.saveGrade]);}
